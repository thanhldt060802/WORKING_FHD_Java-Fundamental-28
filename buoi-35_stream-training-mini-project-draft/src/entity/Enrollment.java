...
public class Enrollment {  // Ghi nhận môn học

    private Long id;  // Mã số ghi nhận môn học
    private Long studentId;  // Mã số sinh viên
    private Long courseId;  // Mã số khoá học
