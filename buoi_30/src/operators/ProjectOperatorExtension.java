...
public interface ProjectOperatorExtension {
    ...
    public abstract ArrayList<Project> getProjectListWithProgressCompleted();

    public abstract ArrayList<Project> getProjectListContainsMemberWithJobCategoryBy(String jobCategory);

    public abstract ArrayList<Project> getProjectListHasNumberOfMemberWithJobCategoryInRange(int min, int max, String jobCategory);
