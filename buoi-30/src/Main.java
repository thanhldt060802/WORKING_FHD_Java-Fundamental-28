...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Member member1 = new Member("M05", "A", "Developer");
		// Member member2 = new Member("M02", "B", "Tester");
		// Member member3 = new Member("M01", "C", "Developer");
		// Member member4 = new Member("M04", "D", "Designer");
		// Member member5 = new Member("M03", "E", "Developer");
		// Member member6 = new Member("M07", "F", "Designer");
        // Member member7 = new Member("M06", "D", "Designer");
		// Member member8 = new Member("M09", "E", "Tester");
		// Member member9 = new Member("M08", "C", "Developer");
		// Member member10 = new Member("M10", "A", "Tester");
        ...
        // System.out.println("Before sorting:");
        // printList(mo.getMemberList());
        // mo.sortByNumberOfProjectsAscending();
        // System.out.println("After sorting:");
        // printList(mo.getMemberList());
        // System.out.println("Validate:");
        // for (Member m : mo.getMemberList()) {
        ...
        // System.out.println("Before sorting:");
        // printList(mo.getMemberList());
        // mo.sortByIdAscending();
        // System.out.println("After sorting:");
        // printList(mo.getMemberList());

        // ArrayList<Project> result = po.getProjectListWithProfitInRange(1500, 2500);
        // printList(result);
        // System.out.println("Validate:");
        // for (Project p : po.getProjectList()) {
        //     System.out.println(String.format("Id=%s Profit=%f", p.getId(), p.getProfit()));
        // }

        // ArrayList<Project> result = po.getProjectListWithProgressCompleted();
        // printList(result);
        // System.out.println("Validate:");
        // for (Project p : po.getProjectList()) {
        //     System.out.println(String.format("Id=%s Progress=%f", p.getId(), p.getProgress()));
        // }

        // ArrayList<Project> result = po.getProjectListContainsMemberWithJobCategoryBy("Tester");
        // printList(result);
        // System.out.println("Validate:");
        // for (Project p : po.getProjectList()) {
        //     System.out.println(String.format("Id=%s, MemberList:", p.getId()));
        //     printList(p.getMemberList());
        // }

        ArrayList<Project> result = po.getProjectListHasNumberOfMemberWithJobCategoryInRange(2, 3, "Developer");
        printList(result);
        System.out.println("Validate:");
        for (Project p : po.getProjectList()) {
            System.out.println(String.format("Id=%s, MemberList:", p.getId()));
